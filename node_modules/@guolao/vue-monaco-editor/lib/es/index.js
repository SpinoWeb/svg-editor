...
import { computed, shallowRef, onMounted, defineComponent, onUnmounted, watch, h, nextTick, ref } from 'vue-demi';
...
function defaultSlotHelper(defaultSlots) {
...
var VueMonacoEditor = defineComponent({
  ...
  setup(props, ctx) {
    ...
    watch(
      () => props.language,
      (language) => isEditorReady.value && monacoRef.value.editor.setModelLanguage(editorRef.value.getModel(), language)
    );
    watch(
      () => props.line,
      (line) => {
...
var VueMonacoDiffEditor = defineComponent({
  ...
  setup(props, ctx) {
    ...
    watch(
      ...
      () => {
        var _a, _b;
        (_b = (_a = diffEditorRef.value) == null ? void 0 : _a.getModel()) == null ? void 0 : _b.original.setValue((props == null ? void 0 : props.original) || "");
      }
    );
    watch(
